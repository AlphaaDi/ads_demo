### Our library usecase
```python
from flowformer import OpticalFlowFormer
from flowformer.optical_flow_former import read_frames

from pathlib import Path

opt_flow = OpticalFlowFormer('flow_form_lib/things.pth')
frames = read_frames(str(Path('DAVIS/JPEGImages/480p/bear')))
print('frames', frames[0].max())  # frames 255
flows = opt_flow(frames)
print('flows', flows[0].max())  # flows tensor(3.1208)
```
